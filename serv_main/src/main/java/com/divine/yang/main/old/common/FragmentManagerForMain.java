...
// import com.divine.yang.main.old.fragment.HomeFragment;
// import com.divine.yang.main.old.fragment.UserFragment;
...
//         int mainType = (int) SPUtils.getInstance(mContext).get(Main.SP_KEY_APP_TYPE, 0);
//         switch (mainType) {
//             case 0:
